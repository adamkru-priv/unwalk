...
export function ReceivedInvitationsSlots({ 
  ...
  return (
    <div className="bg-gradient-to-br from-purple-900/30 via-pink-900/20 to-blue-900/30 border border-purple-500/30 rounded-3xl p-5">
      {/* Header */}
        ...
        {receivedInvitations.map((invitation, index) => {
          ...
          return (
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-4 relative overflow-hidden"
            >
              {/* Glow effect */}
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-sm text-purple-300 mb-1 flex items-center gap-1.5">
                      <span>🤝</span>
