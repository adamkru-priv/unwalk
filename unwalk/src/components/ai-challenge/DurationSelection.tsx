      ...
      <div className="relative z-10 text-center mb-8">
        <div className="inline-block mb-4">
          <div className="relative">
            ...
            <div className="relative w-20 h-20 bg-gradient-to-br from-cyan-400 via-blue-500 to-blue-600 rounded-full flex items-center justify-center shadow-2xl">
        ...
        <p className="text-cyan-400 text-base font-bold">Choose your race duration</p>
      </div>
          ...
          <div className="relative p-6 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-cyan-100 text-xs font-bold uppercase tracking-wider">Lightning Sprint</p>
              </div>
            </div>
        ...
        >
          ...
          <div className="relative p-6 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <h3 className="text-3xl font-black text-white mb-1">60s</h3>
                <p className="text-orange-100 text-xs font-bold uppercase tracking-wider">Endurance Race</p>
              </div>
            </div>
            <div className="text-4xl text-white/40 group-hover:text-white/90 group-hover:translate-x-2 transition-all">
              →
