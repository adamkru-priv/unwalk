-- Fix incorrect column name in get_user_achievement_stats function
-- Change ac.target_steps -> ac.goal_steps
...
BEGIN
  ...
  SELECT
    ...
    -- FIX: Changed ac.target_steps -> ac.goal_steps (correct column name)
